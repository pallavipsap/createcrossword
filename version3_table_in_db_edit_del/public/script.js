...
function insertNewRecord(data) {
  ...
  // console.log(document.getElementById("instuctions"));
  // newRow.form = "saveForm";
  ...
  var cell0 = newRow.insertCell(0); // number added by css
  ...
  final_quiz.ques_ans_data.push(QA); //[ table : { }]
  // var j_object = JSON.stringify(final_quiz);
  // console.log("String json object",j_object);
  // var textarea_data = document.getElementById("check_qa");
  // textarea_data.innerHTML = final_quiz; // set value

  //final_quiz.push(QA);
  var textarea_data = document.getElementById("check_qa");
  textarea_data.innerHTML = JSON.stringify(final_quiz.ques_ans_data); // set value
  ...
  // console.log(document.getElementById("entiretable"));
}
...
function updateRecord(formData) {
  ...
  final_quiz.ques_ans_data[selectedRow.rowIndex-1].question = formData.question;
  final_quiz.ques_ans_data[selectedRow.rowIndex-1].answer = formData.answer;
...
function onDelete(td) {
  ...
  if (confirm("Are you sure to delete this record?")) {
    ...
    console.log("Row to be deleted", final_quiz.ques_ans_data[row.rowIndex-1] );
    final_quiz.ques_ans_data.splice(row.rowIndex-1,1)
    console.log("final_quiz after deletion",final_quiz.ques_ans_data);
    //delete final_quiz.ques_ans_data[row.rowIndex-1]; // does not work adds null values
